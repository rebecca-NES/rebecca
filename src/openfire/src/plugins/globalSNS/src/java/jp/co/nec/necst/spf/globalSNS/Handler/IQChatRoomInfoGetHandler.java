...
public class IQChatRoomInfoGetHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQChatRoomInfoGetHandler() {
        super("Get Chat Room Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/getchatroominfo");
    }
    ...
    private IQ execIQ(IQ packet) {
        return GroupChatAdapter.getInstance().getGroupChatRoomInfo(packet);
    }
