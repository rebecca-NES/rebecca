...
public class IQChatRoomCreateHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQChatRoomCreateHandler() {
        super("Create Chat Room Handler");
    ...
    private IQ execIQ(IQ packet) {
        return GroupChatAdapter.getInstance().createGroupChatRoom(packet);
    }
