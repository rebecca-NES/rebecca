...
public class IQChatRoomListGetHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQChatRoomListGetHandler() {
        super("Get Chat Room List Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/getgroupchatlist");
    }
    ...
    private IQ execIQ(IQ packet) {
        return GroupChatAdapter.getInstance().getGroupChatRoomList(packet);
    }
}
