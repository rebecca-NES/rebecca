...
public class IQThreadMessageGetHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQThreadMessageGetHandler() {
        super("Get Thread Message Handler");
        mInfo = new IQHandlerInfo("message",
                "http://necst.nec.co.jp/protocol/threadmessage");
    }
    ...
    private IQ execIQ(IQ packet) {
        return MessageAdapter.getInstance().getThreadMessage(packet);
    }
