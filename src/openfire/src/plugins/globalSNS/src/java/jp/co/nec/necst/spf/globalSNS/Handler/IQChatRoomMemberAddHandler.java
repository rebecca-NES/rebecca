...
public class IQChatRoomMemberAddHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQChatRoomMemberAddHandler() {
        super("Add Chat Room Member Handler");
    ...
    private IQ execIQ(IQ packet) {
        return GroupChatAdapter.getInstance().addGroupChatMember(packet);
    }
