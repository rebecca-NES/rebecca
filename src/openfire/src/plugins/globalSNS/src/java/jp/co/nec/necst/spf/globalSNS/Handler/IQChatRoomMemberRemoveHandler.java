...
public class IQChatRoomMemberRemoveHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQChatRoomMemberRemoveHandler() {
        super("Remove ChatRoom Member Handler");
    ...
    private IQ execIQ(IQ packet) {
        return GroupChatAdapter.getInstance().removeGroupChatMember(packet);
    }
