...
public class IQDeviceInfoDeleteHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQDeviceInfoDeleteHandler() {
        super("delete DeviceInfo Handler");
        mInfo = new IQHandlerInfo("device_info",
                "http://necst.nec.co.jp/protocol/deviceinfo/delete");
    }
    ...
    private IQ execIQ(IQ packet) {
        return DeviceInfoAdapter.getInstance().deleteDeviceInfo(packet);
    }
