...
public class IQMailCooperationSettingsSetHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQMailCooperationSettingsSetHandler() {
        super("Set Mail Cooperation Settings Handler");
        mInfo = new IQHandlerInfo("mail",
                "http://necst.nec.co.jp/protocol/setsettings");
    }
    ...
    private IQ execIQ(IQ packet) {
        return MailCooperationAdapter.getInstance().setMailCooperationSettings(
                packet);
    }
