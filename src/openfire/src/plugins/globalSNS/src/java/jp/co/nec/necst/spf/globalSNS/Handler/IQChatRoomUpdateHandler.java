...
public class IQChatRoomUpdateHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQChatRoomUpdateHandler() {
        super("Update Chat Room Handler");
    ...
    private IQ execIQ(IQ packet) {
        return GroupChatAdapter.getInstance().updateGroupChatRoom(packet);
    }
