...
public class IQMessageSearchHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQMessageSearchHandler() {
        super("Message Search Handler");
        mInfo = new IQHandlerInfo("message",
                "http://necst.nec.co.jp/protocol/search");
    }
    ...
    private IQ execIQ(IQ packet) {
        ...
        return MessageAdapter.getInstance().searchMessage(packet);
    }
}
