...
public class IQCommunityInfoGetHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQCommunityInfoGetHandler() {
        super("Get Community Infomation Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/getcommunityinfo");
    }
    ...
    private IQ execIQ(IQ packet) {
        return CommunityAdapter.getInstance().getCommunityInfo(packet);
    }
}
