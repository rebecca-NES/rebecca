...
public class CommunityMessageDbHelper extends MessageStoreDbHelper {
    @SuppressWarnings("deprecation")
    public static int getNextCommunityMessageIdNumber(String fromJid) {
        int retNumber = 0;
        if (fromJid == null) {
            return retNumber;
        }
        String messageIdPrefix = getCommunityMessageItemIdPrefix(fromJid);
        ...
        String sql = "SELECT " + COLUMN_ID_NAME + ", " + COLUMN_ITEM_ID_NAME
                ...
                + "=" + Message.TYPE_COMMUNITY + " AND " + COLUMN_ITEM_ID_NAME
                + " ~ E'^"
    ...
    public static String getCommunityMessageItemIdPrefix(String fromJid) {
        String ret = "";
        if (fromJid == null) {
            return ret;
        }
        String accountName = fromJid.split("@")[0];
        ret = "comm_" + accountName + "_";
        return ret;
    }
}
