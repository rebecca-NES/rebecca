...
public class IQMailServerListGetHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQMailServerListGetHandler() {
        super("Get Mail Server List Handler");
        mInfo = new IQHandlerInfo("mail",
                "http://necst.nec.co.jp/protocol/getserverlist");
    }
    ...
    private IQ execIQ(IQ packet) {
        return MailCooperationAdapter.getInstance().getMailServerList(packet);
    }
}
