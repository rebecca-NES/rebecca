...
public class IQCommunityOwnerUpdateHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQCommunityOwnerUpdateHandler() {
        super("Update Community Owner Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/updatecommunityowner");
    }
    ...
    private IQ execIQ(IQ packet) {
        return CommunityAdapter.getInstance().updateCommunityOwner(packet);
    }
