...
public class IQCommunityMemberInfoGetHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQCommunityMemberInfoGetHandler() {
        super("Get Community Member Infomation Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/getcommunitymemberinfo");
    }
    ...
    private IQ execIQ(IQ packet) {
        return CommunityAdapter.getInstance().getCommunityMemberInfo(packet);
    }
}
