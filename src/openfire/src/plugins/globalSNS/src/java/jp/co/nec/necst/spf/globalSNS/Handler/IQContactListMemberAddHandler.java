...
public class IQContactListMemberAddHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQContactListMemberAddHandler() {
        super("Add Contact List Member Handler");
        mInfo = new IQHandlerInfo("message",
                "http://necst.nec.co.jp/protocol/addcontactlistmember");
    }
    ...
    private IQ execIQ(IQ packet) {
        return ContactAdapter.getInstance().addMember(packet);
    }
