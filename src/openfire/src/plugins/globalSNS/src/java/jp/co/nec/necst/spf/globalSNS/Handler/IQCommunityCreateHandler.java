...
public class IQCommunityCreateHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQCommunityCreateHandler() {
        super("Create Community Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/createcommunity");
    }
    ...
    private IQ execIQ(IQ packet) {
        return CommunityAdapter.getInstance().createCommunity(packet);
    }
