...
public class IQCommunityMemberAddHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQCommunityMemberAddHandler() {
        super("Add Community Member Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/addcommunitymember");
    }
    ...
    private IQ execIQ(IQ packet) {
        return CommunityAdapter.getInstance().addCommunityMember(packet);
    }
