...
public class IQContactListMemberRemoveHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQContactListMemberRemoveHandler() {
        super("Remove Contact List Member Handler");
    ...
    private IQ execIQ(IQ packet) {
        return ContactAdapter.getInstance().removeMember(packet);
    }
