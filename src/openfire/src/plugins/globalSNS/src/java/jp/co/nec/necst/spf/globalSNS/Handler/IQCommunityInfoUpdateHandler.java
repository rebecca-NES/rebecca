...
public class IQCommunityInfoUpdateHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQCommunityInfoUpdateHandler() {
        super("Update Community Infomation Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/updatecommunityinfo");
    }
    ...
    private IQ execIQ(IQ packet) {
        return CommunityAdapter.getInstance().updateCommunityInfo(packet);
    }
