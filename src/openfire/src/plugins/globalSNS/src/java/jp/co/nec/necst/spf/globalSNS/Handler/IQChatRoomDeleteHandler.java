...
public class IQChatRoomDeleteHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQChatRoomDeleteHandler() {
        super("Delete Chat Room Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/deletechatroom");
    }
    ...
    private IQ execIQ(IQ packet) {
        return GroupChatAdapter.getInstance().deleteGroupChatRoom(packet);
    }
