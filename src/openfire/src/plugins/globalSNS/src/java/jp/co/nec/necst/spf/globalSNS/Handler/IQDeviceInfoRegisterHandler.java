...
import jp.co.nec.necst.spf.globalSNS.ContextHub.DeviceInfoAdapter;
...
public class IQDeviceInfoRegisterHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQDeviceInfoRegisterHandler() {
        super("register DeviceInfo Handler");
        mInfo = new IQHandlerInfo("device_info",
                "http://necst.nec.co.jp/protocol/deviceinfo/register");
    }
    ...
    private IQ execIQ(IQ packet) {
        return DeviceInfoAdapter.getInstance().registerDeviceInfo(packet);
    }
