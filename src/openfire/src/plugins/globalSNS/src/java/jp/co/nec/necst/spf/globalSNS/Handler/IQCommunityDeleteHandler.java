...
public class IQCommunityDeleteHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQCommunityDeleteHandler() {
        super("Update Community Infomation Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/deletecommunity");
    }
    ...
    private IQ execIQ(IQ packet) {
        return CommunityAdapter.getInstance().deleteCommunity(packet);
    }
