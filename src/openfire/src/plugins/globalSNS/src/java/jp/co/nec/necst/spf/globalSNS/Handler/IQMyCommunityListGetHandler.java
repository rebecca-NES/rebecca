...
public class IQMyCommunityListGetHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQMyCommunityListGetHandler() {
        super("Get My Community Handler");
        mInfo = new IQHandlerInfo("group",
                "http://necst.nec.co.jp/protocol/getmycommunitylist");
    }
    ...
    private IQ execIQ(IQ packet) {
        return CommunityAdapter.getInstance().getCommunityList(packet);
    }
}
