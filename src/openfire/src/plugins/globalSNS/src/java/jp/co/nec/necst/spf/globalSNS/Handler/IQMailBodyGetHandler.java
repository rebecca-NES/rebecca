...
public class IQMailBodyGetHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQMailBodyGetHandler() {
        super("Get Mail Body Handler");
        mInfo = new IQHandlerInfo("message",
                "http://necst.nec.co.jp/protocol/getmailbody");
    }
    ...
    private IQ execIQ(IQ packet) {
        return MailCooperationAdapter.getInstance().getMailBody(packet);
    }
