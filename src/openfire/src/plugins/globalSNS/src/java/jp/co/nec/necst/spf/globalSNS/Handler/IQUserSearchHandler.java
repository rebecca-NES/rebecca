...
public class IQUserSearchHandler extends IQHandler implements
        IMultipleThreadHandleIQ {

    private IQHandlerInfo mInfo = null;

    public IQUserSearchHandler() {
        super("User Search Handler");
        mInfo = new IQHandlerInfo("message",
                "http://necst.nec.co.jp/protocol/searchperson");
    }
    ...
    private IQ execIQ(IQ packet) {
        return UserAdapter.getInstance().searchPerson(packet);
    }
