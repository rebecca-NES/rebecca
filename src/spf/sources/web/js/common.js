...
$(function(){
  ...
  $('#mainHeader .ui-sortable .sortable-item').on('click', function () {
    ...
    $(document).on('mouseenter', '.frm-existing-reader-link:has(>.mTip), .good-job-counter:has(>.mTip)', function () {
    ...
    $(document).on('mouseleave', '.frm-existing-reader-link:has(>.mTip), .good-job-counter:has(>.mTip)', function () {
