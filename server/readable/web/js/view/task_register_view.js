...
function TaskRegister(parentObject, message, mode){
    ...
    _proto.getRegisterForm = function(){
        ...
        // (_ownerValue == null)
        _ret += '<textarea class="field task-register-item register-owner-input ui-corner-all autocomplete" placeholder="' + Resource.getMessage('dialog_placeholder_account') + '" ' + _enabled + '>' + ((_ownerValue == undefined)? '' : _ownerValue) + '</textarea>';
        _ret += '    </div>';
